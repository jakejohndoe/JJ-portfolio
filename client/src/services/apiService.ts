...
function getFallbackData<T>(endpoint: string): T {
  ...
  const fallbacks: Record<string, FallbackItem> = {
    ...
    '/projects': [
      ...
      { id: 2, title: 'ReWork', description: 'Rework your resume for any job in one click.', tech: ['Next.js', 'React', 'Tailwind CSS', 'AI/ML', 'Vercel'], imageUrl: 'https://www.rework.solutions/_next/image?url=%2Frework-logo-detailed.png&w=1920&q=75', link: 'https://www.rework.solutions' },
